...
use parachain_template_runtime::Runtime;
use runtime::{AccountId, AuraId, FrontierPrecompiles, Signature, DOLLARS, EXISTENTIAL_DEPOSIT};
    ...
    serde_json::json!({
        ...
        "evm": {
            "accounts": BTreeMap::from_iter(
                FrontierPrecompiles::<Runtime>::set()
                    .into_iter()
                    .map(|p| {
                        (
                            H160(p),
                    ...
                    .chain([
                        ...
                        (
                            ...
                            GenesisAccount {
                                nonce: 1.into(),
                                balance: (10_000_000 * DOLLARS).into(),
                                storage: Default::default(),
                                code: vec![0x00],
                            },
                        ),
